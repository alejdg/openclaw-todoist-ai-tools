...
export declare const validateGoal: (input: unknown) => {
    [x: string]: unknown;
    id: string;
...
}, validateGoalArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    ownerType: "USER" | "WORKSPACE";
    ownerId: string;
...
export declare const validateWorkspaceGoal: (input: unknown) => {
    ...
    createdAt: Date;
    updatedAt: Date;
}, validateWorkspaceGoalArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    workspaceId: string;
    title: string;
...
export declare const validateViewOptions: (input: unknown) => {
    ...
    groupedBy?: "WORKSPACE" | "PROJECT" | "LABEL" | "ASSIGNEE" | "ADDED_DATE" | "DUE_DATE" | "DEADLINE" | "PRIORITY" | null | undefined;
    filteredBy?: string | null | undefined;
    viewMode?: "LIST" | "BOARD" | "CALENDAR" | undefined;
    showCompletedTasks?: boolean | undefined;
    sortedBy?: "WORKSPACE" | "PROJECT" | "ASSIGNEE" | "ADDED_DATE" | "DUE_DATE" | "DEADLINE" | "PRIORITY" | "MANUAL" | "ALPHABETICALLY" | null | undefined;
