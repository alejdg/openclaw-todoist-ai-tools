...
exports.WorkspaceGoalMilestoneSchema = zod_1.z.looseObject({
    id: zod_1.z.string(),
    title: zod_1.z.string(),
    isCompleted: zod_1.z.boolean(),
});
exports.WorkspaceGoalProgressSchema = zod_1.z.looseObject({
    completedItems: zod_1.z.number().int(),
    totalItems: zod_1.z.number().int(),
});
exports.WorkspaceGoalSchema = zod_1.z.looseObject({
    id: zod_1.z.string(),
