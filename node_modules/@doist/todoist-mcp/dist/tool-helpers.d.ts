import { isPersonalProject, isWorkspaceProject, ActivityEvent, ColorKey, Comment, CurrentUser, Goal, Label, MoveTaskArgs, PersonalProject, Reminder, Section, Task, TodoistApi, WorkspaceProject } from '@doist/todoist-sdk';
 ...
 */
declare function mapGoal(goal: Goal): {
    id: string;
    name: string;
...
export { countRemindersByType, getTasksByFilter, mapActivityEvent, mapComment, mapGoal, mapProject, mapReminder, mapTask, };
