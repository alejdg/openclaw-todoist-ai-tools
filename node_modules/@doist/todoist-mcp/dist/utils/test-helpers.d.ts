import { CurrentUser, Goal, Label, PersonalProject, Section, Task, WorkspaceProject } from '@doist/todoist-sdk';
 ...
 * Pass only the properties you want to override for your specific test.
 */
export declare function createMockGoal(overrides?: Partial<Goal>): Goal;
/**
