...
export declare const ToolNames: {
    ...
    readonly FIND_GOALS: "find-goals";
    readonly ADD_GOALS: "add-goals";
    readonly UPDATE_GOALS: "update-goals";
    readonly COMPLETE_GOALS: "complete-goals";
    readonly LINK_GOAL_TASKS: "link-goal-tasks";
